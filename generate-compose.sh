...
# Generate docker-compose.certs.yml for cert extractor
cat > docker-compose.certs.yml << EOF
# This file is auto-generated by generate-compose.sh
# Do not edit manually
...
if command -v docker &> /dev/null; then
    ...
    # Поддержка нескольких compose файлов
    $DOCKER_COMPOSE -f docker-compose.yml \
                    -f docker-compose.override.yml \
                    -f docker-compose.certs.yml up -d --force-recreate

    echo "✅ Traefik + dashboard + certs exporter restarted successfully!"
else
    echo "❎ Docker not found - skipping restart"
    echo ""
    echo "To restart manually run (depending on your version):"
    echo "docker-compose -f docker-compose.yml -f docker-compose.override.yml -f docker-compose.certs.yml up -d"
    echo "or"
    echo "docker compose -f docker-compose.yml -f docker-compose.override.yml -f docker-compose.certs.yml up -d"
fi
